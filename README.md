...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/physics-tenpy-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/physics-tenpy-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add physics-tenpy
# for installing globally
pixi global install physics-tenpy
```
...
It is possible to list all of the versions of `physics-tenpy` available on your platform:
...
```
pixi search physics-tenpy --channel conda-forge
```
